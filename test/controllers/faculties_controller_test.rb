...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { faculty_code: @faculty.faculty_code, faculty_name: @faculty.faculty_name } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { faculty_code: @faculty.faculty_code, faculty_name: @faculty.faculty_name } }
